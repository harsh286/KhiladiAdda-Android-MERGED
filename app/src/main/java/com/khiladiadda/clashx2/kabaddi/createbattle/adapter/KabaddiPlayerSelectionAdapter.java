...
public class KabaddiPlayerSelectionAdapter extends RecyclerView.Adapter<KabaddiPlayerSelectionAdapter.EventHolder> {
    ...
    public KabaddiPlayerSelectionAdapter(List<KaPlayerHTH> kaplayerList, List<CaptainTeamHTH> captainHTH, List<CaptainTeamHTH> OppentHTH) {
