...
public class KabaddiAllBattlesAdapter extends RecyclerView.Adapter<KabaddiAllBattlesAdapter.PersonViewHolder> {
    ...
    public KabaddiAllBattlesAdapter(List<BattlesDeatilsHTH> mEventList, String mid) {
