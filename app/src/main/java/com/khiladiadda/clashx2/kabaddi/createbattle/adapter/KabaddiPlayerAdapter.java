...
import com.khiladiadda.clashx2.kabaddi.createbattle.KabaddiKaPlayer;
...
public class KabaddiPlayerAdapter extends RecyclerView.Adapter<KabaddiPlayerAdapter.EventHolder> {

    private List<KabaddiKaPlayer> mBatmaslist;
    private IOnItemChildClickListener mOnItemChildClickListener;

    public KabaddiPlayerAdapter(List<KabaddiKaPlayer> kaplayerList) {
    ...
    public void onBindViewHolder(EventHolder holder, int position) {
        KabaddiKaPlayer details = mBatmaslist.get(position);
