...
import com.khiladiadda.clashx2.football.createbattle.adapter.FootballHeadToHeadFragmentPagerAdapter;
import com.khiladiadda.clashx2.football.createbattle.fragment.FootballPlayerFragment;
import com.khiladiadda.clashx2.football.createbattle.fragment.FootballReviewFragment;
import com.khiladiadda.clashx2.football.createbattle.interfaces.IFootballCreateBattlePresenter;
import com.khiladiadda.clashx2.football.createbattle.interfaces.IFootballCreateBattleView;
...
public class FootballCreateTeamActivity extends BaseActivity implements IFootballCreateBattleView, ViewPager.OnPageChangeListener {
    ...
    private IFootballCreateBattlePresenter mPresenter;
    ...
    protected int getContentView() {
        return R.layout.activity_football_create_team;
    }
    ...
    protected void initVariables() {
        mPresenter = new FootballCreateBattlePresenter(this);
    ...
    private void onData() {
        mFragmentList.add(FootballReviewFragment.getInstance());
        FootballHeadToHeadFragmentPagerAdapter mAdapter = new FootballHeadToHeadFragmentPagerAdapter(getSupportFragmentManager(), mFragmentList);
    ...
    private void createTeam() {
        mFragmentList.add(FootballPlayerFragment.getInstanceCreateBattle(mMatchDetail.getKaPlayers(), AppConstant.PLAYER_BATSMAN));
        mFragmentList.add(FootballPlayerFragment.getInstanceCreateBattle(mMatchDetail.getKaPlayers(), AppConstant.PLAYER_BOWLER));
        mFragmentList.add(FootballPlayerFragment.getInstanceCreateBattle(mMatchDetail.getKaPlayers(), AppConstant.PLAYER_ALL_ROUNDER));
        mFragmentList.add(FootballPlayerFragment.getInstanceCreateBattle(mMatchDetail.getKaPlayers(), AppConstant.PLAYER_WICKET_KEEPER));
    }

    private void opponentTeam() {
        mFragmentList.add(FootballPlayerFragment.getInstance(mMatchDetail.getKaPlayers(), mBattleList.getCaptainTeam(), AppConstant.PLAYER_BATSMAN));
        mFragmentList.add(FootballPlayerFragment.getInstance(mMatchDetail.getKaPlayers(), mBattleList.getCaptainTeam(), AppConstant.PLAYER_BOWLER));
        mFragmentList.add(FootballPlayerFragment.getInstance(mMatchDetail.getKaPlayers(), mBattleList.getCaptainTeam(), AppConstant.PLAYER_ALL_ROUNDER));
        mFragmentList.add(FootballPlayerFragment.getInstance(mMatchDetail.getKaPlayers(), mBattleList.getCaptainTeam(), AppConstant.PLAYER_WICKET_KEEPER));
    }

    private void CapatainTeam() {
        mFragmentList.add(FootballPlayerFragment.getInstance(mMatchDetail.getKaPlayers(), mBattleList.getOpponentTeam(), AppConstant.PLAYER_BATSMAN));
        mFragmentList.add(FootballPlayerFragment.getInstance(mMatchDetail.getKaPlayers(), mBattleList.getOpponentTeam(), AppConstant.PLAYER_BOWLER));
        mFragmentList.add(FootballPlayerFragment.getInstance(mMatchDetail.getKaPlayers(), mBattleList.getOpponentTeam(), AppConstant.PLAYER_ALL_ROUNDER));
        mFragmentList.add(FootballPlayerFragment.getInstance(mMatchDetail.getKaPlayers(), mBattleList.getOpponentTeam(), AppConstant.PLAYER_WICKET_KEEPER));
    }
    ...
    private void setPlayersForReview() {
        ...
        for (int i = 0; i < 4; i++) {
            FootballPlayerFragment fragment = (FootballPlayerFragment) mFragmentList.get(i);
        ...
        ((FootballReviewFragment) mFragmentList.get(4)).updatePlayers(reviewList);
    }
...
//        1 = add, 2 = update, 3 = accept
    ...
    public void showMsgSmallDialog(String msg, int mFrom) {
        ...
        okBTN.setOnClickListener(arg0 -> {
            ...
            if (mFrom == 1) {
                dialog.dismiss();
                new FootballCreateBattleDialog(this, onCreateBattleListener, mPlayerList);
            } else if (mFrom == 3) {
