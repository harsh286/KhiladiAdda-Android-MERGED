...
public class FootballPlayerSelectionAdapter extends RecyclerView.Adapter<FootballPlayerSelectionAdapter.EventHolder> {
    ...
    public FootballPlayerSelectionAdapter(List<KaPlayerHTH> kaplayerList, List<CaptainTeamHTH> captainHTH, List<CaptainTeamHTH> OppentHTH) {
