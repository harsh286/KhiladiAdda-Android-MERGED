...
public class FootballCreateBattlePresenter implements IFootballCreateBattlePresenter {

    private IFootballCreateBattleView mView;
    private FootballCreateBattleInteractor mInteractor;
    private Subscription mSubscription;

    public FootballCreateBattlePresenter(IFootballCreateBattleView view) {
        mView = view;
        mInteractor = new FootballCreateBattleInteractor();
    }
