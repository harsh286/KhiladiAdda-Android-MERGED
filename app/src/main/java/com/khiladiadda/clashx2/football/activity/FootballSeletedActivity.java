...
public class FootballSeletedActivity extends BaseActivity implements IHTHBattleView, ICreateBattleView {
    ...
    public void onGetHTHMatchListComplete(HTHMainResponse responseModel) {
        ...
        if (responseModel.isStatus()) {
            if (mCheck == 2) {
                Intent createBattle1 = new Intent(this, FootballCreateTeamActivity.class);
...
//                finish();
                finish();
                Intent i = new Intent(FootballSeletedActivity.this, MyFanLeagueActivityHTH.class);
