...
public class FootballReviewAdapter extends RecyclerView.Adapter<FootballReviewAdapter.ViewHolder> {

    private List<KaPlayerHTH> mReviewList;

    public FootballReviewAdapter(List<KaPlayerHTH> mReviewList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (details.getRole() == AppConstant.PLAYER_BATSMAN) {
            holder.mPRoleTV.setText("Forward");
//            changed text here from batsman to forward
            ...
            holder.mPRoleTV.setText("MidFielder");
            //            changed text here from batsman to forward
        } else {
            holder.mPRoleTV.setText("GK");
            //            changed text here from batsman to forward
        }
