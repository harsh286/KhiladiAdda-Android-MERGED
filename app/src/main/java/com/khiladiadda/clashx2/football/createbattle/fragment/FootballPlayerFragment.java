...
public class FootballPlayerFragment extends BaseFragment implements FootballPlayerSelectionAdapter.IOnItemChildClickListener {

    private List<KaPlayerHTH> mKaplayerList;
    @BindView(R.id.rv_batsman)
    RecyclerView mPlayerRV;
    private FootballPlayerSelectionAdapter mPlayerSelectionAdapter;
    ...
    public FootballPlayerFragment() {// Required empty public constructor
    }

    public static Fragment getInstance(List<KaPlayerHTH> kaPlayerList, List<CaptainTeamHTH> captainHTHList, int type) {
        FootballPlayerFragment batsmanFragment = new FootballPlayerFragment();
    ...
    protected void initVariables() {
        ...
        mPlayerSelectionAdapter = new FootballPlayerSelectionAdapter(mPlayerList, mCaptainHTH,mOppentHTHList);
