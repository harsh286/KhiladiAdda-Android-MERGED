...
public class MyLeaguePastAdapter extends RecyclerView.Adapter<MyLeaguePastAdapter.PersonViewHolder> {

    private List<LeagueListDetails> mEventList;
    private IOnItemClickListener mOnItemClickListener;

    public MyLeaguePastAdapter(List<LeagueListDetails> mEventList) {
    ...
    public PersonViewHolder onCreateViewHolder(ViewGroup viewGroup, int position) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_past_league, viewGroup, false);
...
//            holder.mIV.setImageResource(R.drawable.esports_per);
        ...
        if (details.cancelled) {
            holder.mViewLeaderboardTV.setText(R.string.text_league_cancelled);
        } else {
            holder.mViewLeaderboardTV.setText(R.string.text_view_leaderboard);
        }
    }
