...
public class CxCkScore implements Parcelable {
    ...
    public Integer get_catch() {
        return _catch;
    }

    public void set_catch(Integer _catch) {
        this._catch = _catch;
    }
    ...
    public static final Creator<CxCkScore> CREATOR = new Creator<CxCkScore>() {
        @Override
        public CxCkScore createFromParcel(Parcel source) {
            return new CxCkScore(source);
        }

        @Override
        public CxCkScore[] newArray(int size) {
            return new CxCkScore[size];
        }
    };
}
