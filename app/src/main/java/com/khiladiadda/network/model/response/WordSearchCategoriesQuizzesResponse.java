...
public class WordSearchCategoriesQuizzesResponse implements Parcelable {
    ...
    public WordSearchCategoriesQuizzesResponse() {
    }

    protected WordSearchCategoriesQuizzesResponse(Parcel in) {
    ...
    public static final Creator<WordSearchCategoriesQuizzesResponse> CREATOR = new Creator<WordSearchCategoriesQuizzesResponse>() {
        @Override
        public WordSearchCategoriesQuizzesResponse createFromParcel(Parcel source) {
            return new WordSearchCategoriesQuizzesResponse(source);
        }

        @Override
        public WordSearchCategoriesQuizzesResponse[] newArray(int size) {
            return new WordSearchCategoriesQuizzesResponse[size];
        }
    };
}