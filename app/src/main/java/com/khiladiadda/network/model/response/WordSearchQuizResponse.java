...
public class WordSearchQuizResponse implements Parcelable {
    ...
    public WordSearchQuizResponse() {
    }

    protected WordSearchQuizResponse(Parcel in) {
    ...
    public static final Creator<WordSearchQuizResponse> CREATOR = new Creator<WordSearchQuizResponse>() {
        @Override
        public WordSearchQuizResponse createFromParcel(Parcel source) {
            return new WordSearchQuizResponse(source);
        }

        @Override
        public WordSearchQuizResponse[] newArray(int size) {
            return new WordSearchQuizResponse[size];
        }
    };
}