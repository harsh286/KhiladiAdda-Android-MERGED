...
public class CxCkPoint implements Parcelable {
    ...
    public static final Creator<CxCkPoint> CREATOR = new Creator<CxCkPoint>() {
        @Override
        public CxCkPoint createFromParcel(Parcel source) {
            return new CxCkPoint(source);
        }

        @Override
        public CxCkPoint[] newArray(int size) {
            return new CxCkPoint[size];
        }
    };
}
