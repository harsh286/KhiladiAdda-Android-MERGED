...
public class CxKbScore implements Parcelable {
    ...
    public static final Creator<CxKbScore> CREATOR = new Creator<CxKbScore>() {
        @Override
        public CxKbScore createFromParcel(Parcel source) {
            return new CxKbScore(source);
        }

        @Override
        public CxKbScore[] newArray(int size) {
            return new CxKbScore[size];
        }
    };
}
