...
public class WordSearchTrendingQuizResponse implements Parcelable {
    @SerializedName("_id")
    @Expose
    private String id;
    ...
    public WordSearchTrendingQuizResponse() {
    }

    protected WordSearchTrendingQuizResponse(Parcel in) {
    ...
    public static final Creator<WordSearchTrendingQuizResponse> CREATOR = new Creator<WordSearchTrendingQuizResponse>() {
        @Override
        public WordSearchTrendingQuizResponse createFromParcel(Parcel source) {
            return new WordSearchTrendingQuizResponse(source);
        }

        @Override
        public WordSearchTrendingQuizResponse[] newArray(int size) {
            return new WordSearchTrendingQuizResponse[size];
        }
    };
}