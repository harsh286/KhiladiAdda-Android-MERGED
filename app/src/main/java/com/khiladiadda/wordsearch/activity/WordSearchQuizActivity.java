...
public class WordSearchQuizActivity extends BaseActivity implements IOnClickListener, IWordSearchCategoryQuizView, IWordSearchMyQuizzesView {
    ...
    private void getData() {
        if (new NetworkStatus(this).isInternetOn()) {
            showProgress("");
            if (mCategoryName.equals("My Quizzes")) {
    ...
    public void onWordSearchMyQuizzesComplete(WordSearchMyQuizzesMainResponse responseModel) {
        ...
        if (responseModel.isStatus()) {
            ...
            if (!responseModel.getResponse().isEmpty()) {
                ...
                mQuizzesRv.setAdapter(new WordSearchTrendingQuizAdapter(this, mMyQuizzesMainResponseList, mColorName, "My Tournaments"));
            } else {
                /*Remove this line*/
