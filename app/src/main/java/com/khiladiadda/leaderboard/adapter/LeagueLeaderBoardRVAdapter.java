...
public class LeagueLeaderBoardRVAdapter extends RecyclerView.Adapter<LeagueLeaderBoardRVAdapter.EventHolder> {
    ...
    public LeagueLeaderBoardRVAdapter(List<AllLederBoardDetails> exhibitorList, int from) {
