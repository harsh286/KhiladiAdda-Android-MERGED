...
public class MyChallengeAdapter extends RecyclerView.Adapter<MyChallengeAdapter.LudoContestHolder> {
    ...
    public void setOnItemChildClickListener(MyChallengeAdapter.IOnItemChildClickListener mOnItemChildClickListener) {
    ...
    public LudoContestHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_my_challenge, parent, false);
    ...
    public static class LudoContestHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public LudoContestHolder(View view, IOnItemClickListener onItemClickListener, MyChallengeAdapter.IOnItemChildClickListener onItemChildClickListener) {
            super(view);
