...
public class MyAllLudoUniAdapter extends RecyclerView.Adapter<MyAllLudoUniAdapter.LudoContestHolder> {
        ...
        public void onClick(View v) {
            if (v.getId() == R.id.tv_cancel) {
                if (mOnItemChildClickListener != null) {
                    mOnItemChildClickListener.onCancelClick(getAdapterPosition());
                }
            } else {
