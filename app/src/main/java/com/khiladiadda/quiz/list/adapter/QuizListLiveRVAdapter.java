...
public class QuizListLiveRVAdapter extends RecyclerView.Adapter<QuizListLiveRVAdapter.EventHolder> {

    private List<QuizListDetails> mFDList;
    private IOnItemClickListener mOnItemClickListener;
    private QuizListLiveRVAdapter.IOnItemChildClickListener mOnItemChildClickListener;

    public QuizListLiveRVAdapter(List<QuizListDetails> exhibitorList) {
    ...
    public void setOnItemChildClickListener(QuizListLiveRVAdapter.IOnItemChildClickListener mOnItemChildClickListener) {
    ...
    @Override public void onBindViewHolder(EventHolder holder, int position) {
        ...
        holder.mEndTimeTV.setText(AppUtilityMethods.getQuizRemainingTime(details.getEnd()));
